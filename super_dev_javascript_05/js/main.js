...
document.addEventListener('DOMContentLoaded', function() {
  ...
  validation.init([
    {
      selector: '.name', // <-- selector của thẻ input muốn validation
      name: 'name', // <-- tên gọi của thẻ input muốn validation
      type: 'text', // <-- kiểu muốn validation
      min: 1, // <-- độ dài tối thiểu cho phép ( không nhập thì mặc định là 1 )
